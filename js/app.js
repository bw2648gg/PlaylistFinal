...
var color1= "linear-gradient(135deg, #2b0b1e 0%, #2b0b0b 100%)";
var color2= "linear-gradient(330deg, #2b0b11 0%, #2b0b0b 100%)";
var color3= "linear-gradient(35deg, #2b0b1e 0%, #2b0b11 100%)";
var color4= "linear-gradient(235deg, #2b0b11 0%, #2b0b0b 100%)"; 
...
function getGenre() {
    ...
    for(var i = 0; i < sections.length; i++){
        var genreList = '<table>';
        genreList += '<tr><td>Artist Name:</td><td>' + allGenre[i].artistname + '</td></tr>';
        genreList += '</table>';

        genreList += '<p><img src="images/' + allGenres[i].genreImg + '.jpeg" alt></p>';

        genreList += '<span> Artist Song Name: </span> <hr> <p>' + allGenres[i].songname + ' '; 
        genreList +=  '</p>'; 

 //albumImg(imgsrc="images/computerWorld.jpeg", alt="Computer");
//const albumImg = document.createElement('img');
//albumImg.src = '/images/computerWorld.jpeg'
//document.querySelector('.wrapper').appendChild(albumImg);


        sections[i].innerHTML = genreList;
    }
}
getGenres();